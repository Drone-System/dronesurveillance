#ifndef BACKEND_DATABASE_DATABASE_MANAGER_H
#define BACKEND_DATABASE_DATABASE_MANAGER_H
...
public:
    ...
    {
        // connect
        char conninfo[] = "dbname=postgres user=postgres password=mysecretpassword host=localhost port=5432";
        ...
        char query[] = "SELECT * FROM protocols";
...
#endif //BACKEND_DATABASE_DATABASE_MANAGER_H